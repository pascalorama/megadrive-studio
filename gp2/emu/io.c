...
void gen_io_w(int offset, int value)
{
    switch(offset)
    {
        case 0x01: /* Port A Data */
			...
			level_error(2,"pc:%.8x:Port A DATA write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);
        ...
        case 0x02: /* Port B Data */
			...
			level_error(2,"pc:%.8x:Port B DATA write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);
        ...
        case 0x03: /* Port C Data */
			...
			level_error(2,"pc:%.8x:Port C DATA write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);

            return;  

        case 0x04: /* Port A Ctrl */
			io_reg[offset] = value & 0xFF;
			level_error(2,"pc:%.8x:Port A CTRL write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);
			break;

		case 0x05: /* Port A Ctrl */
			io_reg[offset] = value & 0xFF;
			level_error(2,"pc:%.8x:Port B CTRL write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);
			break;

		case 0x06: /* Port A Ctrl */
			io_reg[offset] = value & 0xFF;
			level_error(2,"pc:%.8x:Port C CTRL write 0x%.2x",m68k_get_reg(NULL, M68K_REG_PC),value);
			break;
