...
/*  modify tas.b and address register indirect predecremented writes, e.g.
    ...
    the changes to m68kcpu.h are always enabled, add define later once
    proper interrupt support is complete.
 */
